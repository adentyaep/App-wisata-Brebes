...
@section ('content')
    <div class="container mt-5">
        ...
        <form action="/wisata/update/{{$data->id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Nama Wisata</label>
                <input type="text" class="form-control" name="frNamaWisata" value="{{ old('nama_wisata') ? old('nama_wisata') : $data->nama_wisata }}">
            </div>
            <div class="mb-3">
